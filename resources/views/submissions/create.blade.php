        ...
        <div class="col-xl-9 order-xl-1">
          <div class="card">
            ...
            <div class="card-body">  
              ...
              <form method="POST" action="{{ route('submissions.store', ['teamId' => $team->id]) }}" enctype="multipart/form-data">
                @csrf
                  ...
                  <div class="row">
                    <div class="col-lg-12">
                      <div class="form-group ">
                        ...
                        <div class="judul">
                          <input id="judul_karya" type="text" name="judul_karya" class="form-control {{ $errors->first('link_subs') ? 'is-invalid' : ''}}" required>  
                    ...
                    @elseif($cabangLomba->link_submission == 1)
                      <div class="col-lg-6">
                        <div class="form-group ">
                          ...
                          <div class="ktmform">
                            <input id="link_subs" type="text" name="link_subs" class="form-control {{ $errors->first('link_subs') ? 'is-invalid' : ''}}" required>  
                            <br>
                ...
                <hr class="my-4" />
                <div class="pl-lg-4">
                    <button type="submit" id="submitKarya" class="btn btn-primary" disabled="true">   Unggah Submission</button>
                </div>
              </form>
            </div>
          </div>
